...
const initialState: OpportunityState = {
    filters: {
        activeFilters: [],
        filterMap: { years: [], credits: [], hourlyPay: 0, majors: [] },
    },
    query: "",
    activeId: "",
    opportunities: [],
...
const OpportunityContext = createContext<OpportunityContextType>({
...
export const OpportunityProvider = ({ children }: { children: React.ReactNode }) => {
    ...
    return (
        <OpportunityContext.Provider value={{ activeFilters: opportunityState.filters.activeFilters, filterMap: opportunityState.filters.filterMap, opportunities: opportunityState.opportunities, resetFilters, removeFilter, setFilters, setQuery, setOpportunities }}>
        {children}
